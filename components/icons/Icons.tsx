...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72-3.72a1.05 1.05 0 0 0-1.485 0L12 15.01l-1.566-1.566a1.05 1.05 0 0 0-1.485 0L5.22 17.193a2.1 2.1 0 0 1-1.98-2.193V10.608c0-.97.616-1.813 1.5-2.097L12 6.75l8.25 1.761Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 10.608L12 8.25l9 2.358-7.5 3.375-9-3.375Z" />
    </svg>
);
